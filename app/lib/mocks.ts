...
export const categories = [
  ...
  { id: 3, name: 'Home', subcategories: ['Kitchen', 'Furniture', 'Decor'] },
  { id: 4, name: 'Beauty', subcategories: ['Skincare', 'Makeup', 'Fragrances'] },
];
...
export const fetchAboutData = async (): Promise<{ teamMembers: TeamMember[] }> => {
